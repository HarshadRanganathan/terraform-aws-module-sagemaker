...
resource "aws_sagemaker_feature_group" "sagemaker_feature_group" {
  ...
  feature_group_name             = "${module.label.id}-sagemaker-feature-group"
  record_identifier_feature_name  = "${module.label.id}-sagemaker-recoder-identifier-feature-name"
  event_time_feature_name        = "${module.label.id}-sagemaker-event-time-feature-name"
