...
variable "user_profile_execution_role" {
  description = "The User Profile execution role arn"
  default     = null
}

variable "user_profile_security_groups" {
  description = "The User Profile Security groups"
  default     = null
}
...
variable "domain_execution_role" {
  description = "The domain execution role arn for user settings"
  default     = null
}

variable "domain_security_groups" {
  description = "The domain Security groups for user settings"
  default     = null
}
...
variable "length" {
  description = "The length of the returned name (including supplied prefix + random characters). If this value is less than length of supplied prefix, it will be truncated such that the resulting string is exactly this length."
  type        = number
  default     = 8
}
...
variable "keepers" {
  description = "Arbitrary map of values that, when changed, will trigger a new id to be generated. See the main provider documentation for more information."
  type        = map
  default     = {}
}
...
variable "enable_sagemaker_app" {
  description = "enable the creation of sagemaker studio app"
  type = bool
  default = false
}
...
variable "app_sagemaker_image_arn" {
  description = "The ARN of the SageMaker image that the image version belongs to."
  type        = string
  default     = null
}

variable "app_sagemaker_image_version_arn" {
...
#---------------------------------------------------
# AWS sagemaker studio lifecycle
#---------------------------------------------------
...
variable "enable_studio_lifecycle_config_content" {
  description = "enable app atudio lifecycle"
  type        = bool
  default     = false
}